...
const Spotify = ({ windowName, windowTitle, setWindowsState }) => {
    return (
        <MacWindow width='25vw' windowName={windowName} windowTitle={windowTitle} setWindowsState={setWindowsState}>
